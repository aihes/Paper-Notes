...
The post-training dataset consisted of vetted instruction tuning data and was a collection of multimodal 
data with paired instructions and responses in addition to human preference and tool-use data. Gemini 
...
case-by-case basis, filtering irrelevant or harmful content, text, and other modalities, including filtering 
...
deepmind.com/models/evals/gemini-3-pro. 
 
Results: Gemini 3 Pro significantly outperforms Gemini 2.5 Pro across a range of benchmarks requiring 
...
such as hallucinations. There may also be occasional slowness or timeout issues. The knowledge cutoff 
...
3.​
Dangerous content (e.g., promoting suicide, or instructing in activities that could cause 
real-world harm) 
...
Gemini 3 Pro outperforms Gemini 2.5 Pro across both safety and tone, while keeping unjustified refusals 
...
evaluations, Gemini 3 Pro satisfied required launch thresholds, which were developed by expert teams 
...
reached? 
CBRN 
The model provides accurate and 
...
reached 
Cybersecurity 
On key skills benchmark, v1 hard challenges:​
11/12 challenge solved; v2 challenges: 0/13 solved 
end-to-end. Alert threshold met.  
Uplift Level 1  
CCL not 
reached 
Harmful 
...
significant uplift versus prior models and did 
not near alert thresholds.  
Level 1 
(exploratory)  
CCL not 
reached 
