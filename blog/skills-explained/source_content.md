...
Features
    ...
    * [Claude in Excel](/claude-for-excel)
...
Since introducing [Skills](https://www.anthropic.com/news/skills), there's been interest in understanding how the various components of Claude's agentic ecosystem work together.Â 

Whether you're building sophisticated workflows in [Claude Code](https://www.claude.com/product/claude-code), creating enterprise solutions with the API, or maximizing your productivity on [Claude.ai](http://claude.ai), knowing which tool to reach forâand whenâcan transform how you work with Claude.
...
Skills are folders containing instructions, scripts, and resources that Claude discovers and loads dynamically when relevant to a task. Think of them as specialized training manuals that give Claude expertise in specific domainsâfrom working with Excel spreadsheets to following your organization's brand guidelines.
...
[Prompts](https://docs.claude.com/en/prompt-library/library) are the instructions you provide to Claude in natural language during a conversation. They're ephemeral, conversational, and reactiveâyou provide context and direction in the moment.
...
**When to use a Skill instead:** If multiple agents or conversations need the same expertiseâlike security review procedures or data analysis methodsâcreate a Skill rather than building that knowledge into individual subagents. Skills are portable and reusable, while subagents are purpose-built for specific workflows. Use Skills to teach expertise that any agent can apply; use subagents when you need independent task execution with specific tool permissions and context isolation.
...
**How subagents work:** Each subagent operates with its own configurationâyou define what it does, how it approaches problems, and which tools it can access. Claude automatically delegates tasks to appropriate subagents based on their descriptions, or you can explicitly request a specific subagent.
...
The Model Context Protocol (MCP) is an open standard for connecting AI assistants to external systems where data livesâcontent repositories, business tools, databases, and development environments.
...
**Example:** Connect Claude to your company's Google Drive via MCP. Now Claude can search documents, read files, and reference internal knowledge without manual uploadsâthe connection persists and updates automatically.

**When to use a Skill instead:** MCP connects Claude to data; Skills teach Claude what to do with that data. If you're explaining _how_ to use a tool or follow proceduresâlike "when querying our database, always filter by date range first" or "format Excel reports with these specific formulas"âthat's a Skill. If you need Claude to _access_ the database or Excel files in the first place, that's MCP. Use both together: MCP for connectivity, Skills for procedural knowledge.
...
**Use Skills when:** You want capabilities that any Claude instance can load and use. Skills are like training materialsâthey make Claude better at specific tasks across all conversations.
...
**Use Skills when:** You have procedures or expertise that you'll need repeatedly. Skills are proactiveâClaude knows when to apply themâand persistent across conversations.
...
**Key difference:** Projects say "here's what you need to know." Skills say "here's how to do things." Projects provide a knowledge base you work within. Skills provide capabilities that work everywhereâany conversation, any project.
...
[**Claude.ai**](https://Claude.ai)**users:**
  ...
  * Enable Skills in Settings â Features
...
Best practices for prompt engineeringBest practices for prompt engineering
...
Building AI agents for healthcare and life sciencesBuilding AI agents for healthcare and life sciences
...
Building AI agents for financial servicesBuilding AI agents for financial services
...
[English (US)](/blog/skills-explained)

[æ¥æ¬èª (Japan)](/ja-jp/blog/skills-explained)

[Deutsch (Germany)](/de-de/blog/skills-explained)

[FranÃ§ais (France)](/fr-fr/blog/skills-explained)
