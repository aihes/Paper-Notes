...
*<p align="center">Figure 1: 论文的目标设定与现有研究的对比。非结构化语言信号与结构化数值数据对于经济决策至关重要。</p>*
...
*<p align="center">Figure 2: LAMP 框架的工作流。(a) “思考”模块提取长期趋势和短期冲击；(b) “交流”模块进行信息广播和信念更新；(c) “决策”模块融合语言和数值信息以选择行动。</p>*
...
*<p align="center">Table 2 & 3: (左) LAMP 与基线模型在回报、社会福利等关键指标上的性能对比。(右) 详细的消融研究数据，验证了各模块的有效性。</p>*

![Figure 3 & 4: 消融研究与鲁棒性测试](./images/f34.png)
*<p align="center">Figure 3 & 4: (左) 消融研究的可视化结果，证明“思考”和“交流”模块的关键作用。(右) 在经济冲击下的鲁棒性测试，显示 LAMP 具有更强的抗风险能力。</p>*
